      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10">
              ...
              <ul className="list-disc text-sm list-inside space-y-2 text-white/80">
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="space-y-6 p-6 rounded-xl bg-white/[0.02] border border-white/10">
            {/* 5.1 기술적 조치 */}
            <div>
              <h3 className="text-md font-medium mb-2">5.1 기술적 조치</h3>
              <ul className="list-disc text-sm list-inside space-y-2 text-white/80">
                <li>개인정보 암호화 저장</li>
                <li>시스템 접근 권한 관리</li>
            ...
            {/* 5.2 관리적 조치 */}
            <div>
              <h3 className="text-md font-medium mb-2">5.2 관리적 조치</h3>
              <ul className="list-disc text-sm list-inside space-y-2 text-white/80">
            ...
            {/* 5.3 보안 취약점 관리 */}
            <div>
              <h3 className="text-md font-medium mb-2">5.3 보안 취약점 관리</h3>
              <ul className="list-disc text-sm list-inside space-y-2 text-white/80">
            ...
            {/* 5.4 데이터 보호 조치 */}
            <div>
              <h3 className="text-md font-medium mb-2">5.4 데이터 보호 조치</h3>
              <ul className="list-disc text-sm list-inside space-y-2 text-white/80">
                <li>데이터 암호화 보관</li>
            ...
            {/* 5.5 보안 사고 대응 */}
            <div>
              <h3 className="text-md font-medium mb-2">5.5 보안 사고 대응</h3>
              <ul className="list-disc text-sm list-inside space-y-2 text-white/80">
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/10">
            ...
            <ul className="list-disc list-inside space-y-2 text-white/80">
              <li>
                개인정보 수정 및 삭제 요청은 AMP 고객센터를 통해 처리됩니다.
                를 통해 처리됩니다.
              </li>
              <li>
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/10">
            <p className="text-white/80 text-sm">
              본 방침은 법령 또는 서비스 정책의 변경에 따라 수정될 수 있습니다.{" "}
              <br />
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/10">
            ...
            <p className="text-sm text-white/60">
              개인정보 처리방침에 대한 문의사항은 고객센터로 연락주시기
              바랍니다.
            </p>
          </div>
        </div>
...
function CollectionCard({ title, items }: { title: string; items: string[] }) {
  return (
    <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10">
      <h4 className="text-sm font-medium mb-2 text-white/90">{title}</h4>
