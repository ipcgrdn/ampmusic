    ...
    <div className="space-y-8">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl text-sm bg-white/[0.02] border border-white/10">
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl text-sm bg-white/[0.02] border border-white/10">
            ...
            <ol className="list-decimal list-inside space-y-3 text-white/80">
              <li>서비스란 AMP가 제공하는 음악 공유 플랫폼을 의미합니다.</li>
              <li>
                이용자란 본 약관에 따라 서비스를 이용하는 회원을 의미합니다.
              </li>
              <li>
                콘텐츠란 서비스 내에서 게시되는 음원, 이미지 등의 파일을
                의미합니다.
              </li>
            </ol>
          </div>
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl text-sm bg-white/[0.02] border border-white/10">
            <ol className="list-decimal list-inside space-y-3 text-white/80">
              개인정보 수집 및 처리에 관한 사항은 개인정보 처리방침을 따릅니다.
            </ol>
          </div>
        </section>
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl text-sm bg-white/[0.02] border border-white/10">
            <ol className="list-decimal list-inside space-y-3 text-white/80">
              청소년 보호에 관한 사항은 청소년 보호정책 을 따릅니다.
            </ol>
          </div>
        </section>
        ...
        <section className="mt-8 space-y-4">
          ...
          <div className="p-6 rounded-xl text-sm bg-white/[0.02] border border-white/10">
            <ol className="list-decimal list-inside space-y-3 text-white/80">
              ...
              <li>기타 민원 처리는 고객센터를 통해 접수 가능합니다.</li>
            </ol>
          </div>
        </section>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-white/60">
              이용약관에 대한 문의사항은 고객센터로 연락주시기 바랍니다.
            </p>
          </div>
        </div>
      </div>
